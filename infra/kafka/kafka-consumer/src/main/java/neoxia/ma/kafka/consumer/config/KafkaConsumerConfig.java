package neoxia.ma.kafka.consumer.config;

import neoxia.ma.kafka.demo.config.data.KafkaConfigData;
import neoxia.ma.kafka.demo.config.data.KafkaConsumerConfigData;
